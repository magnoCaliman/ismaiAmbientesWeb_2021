...
- [https://en.wikipedia.org/wiki/Boilerplate_text][Boilerplate]
...
- estrutura básica: html, head, title, body.
- p, strong, h

- aleixo. tags necessárias
html, head, title, body, h1, h2, h3, h4, hr, p, strong, a, em, ol, ul, li, sup
- trabalhar com GI, entrega (individual) daqui 2 semanas
