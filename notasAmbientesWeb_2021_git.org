...
- Tópicos para sorteio!
  - Design responsivo e /media queries/ - GI #n
  - Transições, animações e transformações - GI #n
  - Manipulação de cores, gradientes e filtros de imagem - GI #n
  - Criação e manipulação de SVG - GI #n
  - Layout e posicionamento de elementos (1) - GI #n
    - Foco em /grid/ e /flexbox/
  - Layout e posicionamento de elementos (2) - GI #n
...
- Baixar exemplos na [[./arquivosAula06/arquivosAula06.zip][pasta de arquivos da aula]]
