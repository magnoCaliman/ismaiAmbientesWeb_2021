...
* AULA 09 - 04/MAI
** Links para acesso trabalhos Momento 2
*** GI 1
- https://github.com/LeonorRaimundo/grupo_1_tutorial
*** GI 2
- https://github.com/paulo-vilar/amb-web_av2
*** GI 3
- https://we.tl/t-xjzvUF5Npe
*** GI 4
- https://github.com/catarinaf5/grupo4_tutorial
*** GI 5
- texto: https://zepedro1998.github.io/Projecto_de_Grupo/
- video: https://www.youtube.com/watch?v=qUGxUXcQN0Q
*** GI 6
- https://github.com/carolinaMarquess/entrega_trabalhoGrupo6_SVG/tree/main
* AULA 10 - 11/MAI
- [[./arquivosAula10/arquivosAula10.zip][Arquivos de exemplos para aula 10]]

- Java-o-quê? - https://htmldog.com/guides/javascript/

** JavaScript 'vanilla'
- https://www.w3schools.com/js/js_intro.asp
- [[./arquivosAula10/oneMillionLols.html][One Million LOLs]]
- https://codepen.io/Mamboleoo/pen/KKdLzjo
- https://www.youtube.com/watch?v=KoWqdEACyLI
- https://github.com/NaiNaiNai17/Tap-Music-using-Javascript
** Bibliotecas externas
- https://p5js.org/
  - [[./arquivosAula10/exemploP5.html][Versão local]]
- http://paperjs.org/
- https://shiffman.net/a2z/intro/
  - https://en.wikipedia.org/wiki/Oulipo
- https://tonejs.github.io/
  - https://teropa.info/
  - https://medium.com/geekculture/creating-a-step-sequencer-with-tone-js-32ea3002aaf5
- E o que mais puderes imaginar: http://js-drinking.projects.frank.petril.li/
* AULA 11 - 18/MAI
- Para reposição
  - Remarcado dia 25/05
* AULA 12.1 && 12.2 - 25/MAI
- Compensação da aula do dia 18/05
- Orientação de projetos

** Sites "inúteis"
- http://onemillionpats.com/
- http://onemillionlols.com/
- https://pointerpointer.com/
- https://wetclap.com/
- https://www.reddit.com/r/WeirdWebsites/
- https://docs.google.com/document/d/1suaew-7W_xzdbeVE1QCXcG0JOFjuaA6e0Eq0CCjIC1A/edit

** Momento 3 
- Projeto final individual - 50% valores do semestre
- Data de entrega: 15/junho
- Formato de entrega: envio no portal de arquivo de texto contendo *link para acesso do site funcional*
