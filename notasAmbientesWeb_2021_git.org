...
- Net Art Anthology - https://anthology.rhizome.org/
  - Explore os trabalhos apresentados em "Chapter 1: 1984-1998". Que tipos de narrativas o espaço "virtual" /hyperlinkado/ proporcionou? Que novas estéticas visuais/sonoras/interativas?
  - Baseado nessa exploração, proponha um site que dialogue com um ou mais aspectos dessas obras.
...
- Bibliografia de apoio (outras estão listadas na Ficha Programática no portal):
  ...
  - [[./docs/crreira_2017.pdf][CARREIRA, Lia (2017) Experimental curating in times of the perpetual beta: strategies and platforms for online-based art]]
