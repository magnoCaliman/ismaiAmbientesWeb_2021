...
- Vocês atuarão como um /grupo de investigação/, e todas as atividades do semestre serão realizadas no contexto desse grupo.
- Ninguém deve estar fora de um grupo! Avisem colegas que não estejam presentes na aula de hoje, para que os grupos estejam montados para a próxima aula.
